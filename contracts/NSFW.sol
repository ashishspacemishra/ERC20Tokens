 ...
 * allowances. See {IERC20-approve}.
 */
contract NSFWAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "NSFW AI | nsfwai.io";
    string private _symbol = "NSFW";
    ...
    address public marketingWallet = 0x4DB71F3246a0C46DaE0FD1d55E36dd12262367A1; // Local2
    address public DEAD = 0x9d1A9cDC740Aed6b1336B05Ca06B58f3dffC1592; // Rinkeby
    ...
    event Log2(address _address, string message);
    event Log3(uint256 value, string message);
